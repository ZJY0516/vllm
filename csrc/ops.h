...
void fused_qk_norm_rope(
    ...
    torch::Tensor& position_ids, int64_t mrope_section_t = 0,
    int64_t mrope_section_h = 0, int64_t mrope_section_w = 0,
    bool mrope_interleaved = false, int64_t forced_token_heads_per_warp = -1);
