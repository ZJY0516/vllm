...
def _get_backend_priorities(
    ...
    if use_mla:
        if device_capability.major == 10:
            ...
            flashinfer_sparse_sm90 = AttentionBackendEnum.FLASHINFER_MLA_SPARSE_SM90
            if head_size == 512:
                sm12x_backends.insert(0, flashinfer_sparse_sm90)
            else:
                sm12x_backends.append(flashinfer_sparse_sm90)
