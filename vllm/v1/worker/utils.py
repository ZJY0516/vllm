...
def copy_kv_cache_blocks_inplace(
    ...
    kernel_block_sizes: list[int],
    cache_dtype: str,
    copy_block_ids: Iterable[tuple[int, int, int, int]],
) -> None:
    copies_by_group: defaultdict[int, list[tuple[int, int, int]]] = defaultdict(list)
    for group_id, src_block_id, dst_block_id, num_tokens in copy_block_ids:
        copies_by_group[group_id].append((src_block_id, dst_block_id, num_tokens))
