...
# Kernel page used when a manager block is re-paged for the sparse MLA kernels;
# the packed block stride is aligned to it (32 keeps the lcm with the 132-byte
# indexer rows small).
MLA_KERNEL_PAGE_ROWS = 32
